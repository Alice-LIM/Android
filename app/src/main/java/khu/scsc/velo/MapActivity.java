...
public class MapActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    private TimeManager.TimeCallback timeCallback = new TimeManager.TimeCallback() {
        ...
        public void perSecond(final int count) {
            MapActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    tEnd.setText(String.format("%02d:%02d:%02d", count / 3600, (count % 3600) / 60, (count % 60)));
                }
            });
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tEnd = (Button)findViewById(R.id.t_end);
        ...
        tEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!timeManager.isRun()) {
                    tEnd.setBackgroundResource(R.drawable.pause);
                    tEnd.setText("00:00:00");
                    ...
                    timeManager.stop();
                    tEnd.setBackgroundResource(R.drawable.end_button);
                    tEnd.setText("운동 시작");
                }
            }
        });
